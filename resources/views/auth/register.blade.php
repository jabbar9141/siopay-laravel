                ...
                <form action="{{ route('register') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="lg:w-[500px] space-y-5 bg-white items-left rounded-xl p-3 shadow-xl">
                        ...
                        <div class="form-group">
                            <label for="surname">{{ __('Surname') }} <i class="text-danger">*</i></label>
                            <input id="surname" type="text"
                                class="form-control @error('surname') is-invalid @enderror rounded-lg" name="name"
                        ...
                        <div class="form-group">
                            <label for="name">{{ __('Name') }} <i class="text-danger">*</i></label>
                            <input id="name" type="text"
                                class="form-control @error('name') is-invalid @enderror rounded-lg" name="name"
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" type="email"
                                class="form-control @error('email') is-invalid @enderror rounded-lg" name="email"
                        ...
                        <div class="form-group">
                            ...
                            <input id="password" type="password"
                                class="form-control @error('password') is-invalid @enderror rounded-lg" name="password"
                        ...
                        <div class="form-group">
                            ...
                            <select name="agency_type" id="agency_type" class="form-control rounded-lg"
                        ...
                        <div class="form-group">
                            <label for="gender">{{ __('Sex') }} <i class="text-danger">*</i></label>
                            <select name="gender" id="gender" class="form-control rounded-lg">
                        ...
                        <div class="form-group">
                            ...
                            <input id="business_name" type="text"
                                class="form-control @error('business_name') is-invalid @enderror rounded-lg" name="business_name"
                        ...
                        <div class="form-group">
                            ...
                            <input id="tax_id_code" type="text"
                                class="form-control @error('tax_id_code') is-invalid @enderror rounded-lg" name="tax_id_code"
                        ...
                        <div class="form-group">
                            ...
                            <input id="vat_no" type="text"
                                class="form-control @error('vat_no') is-invalid @enderror rounded-lg" name="vat_no"
                        ...
                        <div class="form-group">
                            ...
                            <input id="pec" type="text"
                                class="form-control @error('pec') is-invalid @enderror rounded-lg" name="pec"
                        ...
                        <div class="form-group">
                            ...
                            <input id="sdi" type="text"
                                class="form-control @error('sdi') is-invalid @enderror rounded-lg" name="sdi"
                        ...
                        <div class="form-group">
                            ...
                            <input id="phone" type="text"
                                class="form-control @error('phone') is-invalid @enderror rounded-lg" name="phone"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phone_alt" class="form-control rounded-lg" id="phone_alt"
                                value="">
                        </div>

                        <div class="form-group">
                            <label for="address1">{{ __('Address 1') }} <i class="text-danger">*</i></label>
                            <textarea name="address1" class="form-control  @error('phone') is-invalid @enderror rounded-lg" id="address1"></textarea>
                            @error('address1')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address2" class="form-control rounded-lg" id="address2"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="zip" class="form-control @error('phone') is-invalid @enderror rounded-lg" id="zip"
                                value="">
                            @error('zip')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group ">
                            ...
                            <select class="form-control rounded-lg" id="residential_country" name="residential_country">
                        ...
                        <div class="">
                            ...
                            <select class="select2 form-control rounded-lg" id="residential_state" name="residential_state">
                        ...
                        <div class="">
                            ...
                            <select class="form-control rounded-lg" id="residential_city" name="residential_city">
                        ...
                        <div class="form-group">
                            <label for="photo">{{ __('Profile Image') }} <i class="text-danger">*</i></label>
                            <input id="photo" type="file"
                                class="form-control @error('photo') is-invalid @enderror rounded-lg" name="photo"
                        ...
                        <div  class="form-group">
                            ...
                            <input type="file" class="form-control rounded-lg" name="front_attachment" accept="application/pdf">
                            @error('attachment')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div  class="form-group">
                            ...
                            <input type="file" class="form-control rounded-lg" name="attachment" accept="application/pdf">
                            @error('attachment')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
