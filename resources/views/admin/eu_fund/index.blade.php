    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="card-title fw-semibold mb-4">All EU Fund Transfer Orders
                    <a href="{{ route('eu_fund_trasfer_order.create') }}" class="btn btn-primary ml-2" style="float: right">
                        <i class="fas fa-plus"></i>New Order
                    </a>
                    <a href="{{ route('adminEUFundOrdersReportPage') }}" class="btn btn-primary " style="float: right">
                ...
                <div class="bg-gray-200 mt-5 p-3 rounded-xl">
                    <div class="flex justify-between p-3">
                        ...
                        <h1 class="font-bold">EU Fund Transfer Orders</h1>
...
@section('scripts')
    <script>
        $('#orders_tbl').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "{{ route('adminEUFundOrdersList') }}",
                "type": "GET"
            },
            "columns": [{
                    "data": "DT_RowIndex"
