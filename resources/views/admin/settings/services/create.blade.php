    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="fw-bold">Create New Services</h4>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <div class="ui-widget">
                                ...
                                <input style="width: 100%" type="file" name="logo" value="{{ old('logo') }}"
                                    class="form-control" id="logo" autocomplete="off" placeholder="logo" required>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <div class="ui-widget">
                                ...
                                <input style="width: 100%" type="number" name="service_charges"
                                    value="{{ old('service_charges') }}" class="form-control" id="service_charges"
