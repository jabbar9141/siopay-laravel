                            ...
                            <form action="{{ route('transaction_limits.store') }}" method="post">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" min="1" step="any" class="form-control" name="daily_limit" id="daily_limit" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="monthly_limit">Monthly Limit</label>
                                        <input type="number" min="1" step="any" class="form-control" name="monthly_limit" id="monthly_limit" required>
                                    </div>
                                </div>
                                <br>
