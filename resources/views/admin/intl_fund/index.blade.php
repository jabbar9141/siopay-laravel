        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">
                    All Intenational Fund Transfer Orders
                    <a href="{{ route('intl_fund_trasfer_order.create') }}" class="btn btn-primary" style="float: right">
                        New Order
                    </a>
                    <a href="{{ route('adminIntlFundOrdersReportPage') }}" class="btn btn-primary " style="float: right">
                ...
                <div class="bg-gray-200 mt-5 p-3 rounded-xl">
                    <div class="flex justify-between p-3">
                        ...
                        <h1 class="font-bold">Intenational Fund Transfer Orders</h1>
