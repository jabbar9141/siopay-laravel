            ...
            <div class="card-body">
                ...
                <div class="bg-gray-200 mt-5 p-3 rounded-xl">
                    <div class=" p-3">
                        ...
                        <div class="p-2 space-y-2">
                            <h1 class="font-bold">Select Preferred Company</h1>
                            <select name="country" id="" class="w-full p-3 bg-gray-300 rounded-lg">
                                <option value="" disabled>Select Country</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div class="p-2 space-y-2">
                                <h1 class="font-bold">Enter Meter Number</h1>
                                <input placeholder="08123456789" class="w-full p-3 bg-gray-300 rounded-lg" />
                            </div>

                            <div class="p-2 space-y-2">
                                <h1 class="font-bold">Enter Amount</h1>
                                <input placeholder="N2,300" class="w-full p-3 bg-gray-300 rounded-lg" />
                            </div>
