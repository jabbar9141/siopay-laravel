        ...
        <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
            <ul class="navbar-nav flex-row align-items-center justify-content-end">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop3" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="dropdown-menu p-3 dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop3" id="notificationDropDown">
                        <div class="message-body d-flex align-items-center gap-3 mb-2">
                            <div>
                                <img style="width:30px; height:30px; border-radius:50%" src="{{ asset('admin_assets/assets/images/profile/user-1.jpg') }}" alt="">
                            </div>
                            <div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{ asset('admin_assets/assets/images/profile/user-1.jpg') }}" alt="" width="35" height="35" class="rounded-circle">
                    </a>
