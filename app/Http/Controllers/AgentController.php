...
class AgentController extends Controller
{
    ...
    {
        $agent = Auth::user();
        $currency_exchange_rates = null;#CurrencyExchangeRate::get();
    ...
    public function editAgentSitting($id)
    {
        ...
        return view('admin.users.agents.editagents', compact('agent', 'currency_exchange_rates', 'kycManagers', 'accountManagers'));
    }
