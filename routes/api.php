...
Route::post('/webhook/siodatacheck', [WebhookController::class, 'siodataWebHook']);

Route::group(['middleware' => ['jwt.auth']], function () {
    Route::get('/user-kyc-status/{userId}', [UserController::class, 'getKycInfo']);
    Route::get('/user-information', [UserController::class, 'user']);
    ...
    Route::post('/kyc/set-external-id', [KycController::class, 'setExternalKYCApplicantID']);
